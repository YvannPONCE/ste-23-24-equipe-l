...
public class PlaceOrderDefs {
    ...
    public void the_client_pays_the_order_with_credit_card_amount_and_expiration_date(Integer int1, Integer int2, Integer int3, Integer int4) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Then("the amount of credit card became {int}")
    public void the_amount_of_credit_card_became(Integer int1) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    @Given("client choose to pick at {int}:{int} {int}|{int}|{int}")
    public void client_choose_to_pick_at(Integer int1, Integer int2, Integer int3, Integer int4, Integer int5) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
